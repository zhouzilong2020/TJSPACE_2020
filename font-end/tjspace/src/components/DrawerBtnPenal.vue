    ...
    data:()=> {
        return{
            depts:[
                ...
                {title:	"中德学院",	abbr:"	中德	",icon:"img:"+require('../assets/dept_icon/deguo.png')},
                {title:	"中法工程和管理学院",	abbr:"	中法	",icon:"img:"+require('../assets/dept_icon/faguo.png')},
                {title:	"中德工程学院",	abbr:"	德工	",icon:"img:"+require('../assets/dept_icon/deguo.png')},
                {title:	"中意学院",	abbr:"	中意	",icon:"img:"+require('../assets/dept_icon/yidali.png')},
                {title:	"中芬中心",	abbr:"	中芬	",icon:"img:"+require('../assets/dept_icon/fenlan.png')},
                {title:	"中西学院",	abbr:"	中西	",icon:"img:"+require('../assets/dept_icon/xibanya.png')},
                ...
                {title:	"职业技术教育学院",	abbr:"	职教	",icon:"	supervised_user_circle	"},
