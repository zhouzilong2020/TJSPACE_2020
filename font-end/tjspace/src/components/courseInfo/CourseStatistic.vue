  ...
  <div class="course-comment-statistics">
    ...
    <ul class="rating-container row">
      <li>
        <div class="column">
          <strong>课程内容</strong>
          <span class="rating" :class="getRate(commentStatistic.content)">{{
            commentStatistic.content
          }}</span>
        </div>
      </li>
      <li>
        <div class="column">
          <strong>教学水平</strong>
          <span class="rating" :class="getRate(commentStatistic.teaching)">{{
            commentStatistic.teaching
          }}</span>
        </div>
      </li>
      <li>
        <div class="column">
          <strong>评分情况</strong>
          <span class="rating" :class="getRate(commentStatistic.grading)">{{
            commentStatistic.grading
          }}</span>
        </div>
      </li>
      <li>
        <div class="column">
          <strong>课程作业</strong>
          <span class="rating" :class="getRate(commentStatistic.workload)">{{
            commentStatistic.workload
          }}</span>
        </div>
      </li>
    </ul>
